...
grep -Fq "FIRMWARE_SOURCE=\"\$HOME/Documents/Firmware\"" "$PROJECT_ROOT/bkp-main.sh"
grep -Fq "BIG_FIRMWARE_DIR=\"\$DEST_DEVICE/BIG/Firmware\"" "$PROJECT_ROOT/bkp-main.sh"
grep -Fq -- "--ignore-existing" "$PROJECT_ROOT/bkp-main.sh"
grep -Fq -- "--exclude='Firmware/'" "$PROJECT_ROOT/bkp-main.sh"
grep -Fq -- "--exclude='ml4w/wallpapers/'" "$PROJECT_ROOT/bkp-main.sh"
grep -Fq -- "--exclude='./BIG/wallpapers'" "$PROJECT_ROOT/bkp-main.sh"
grep -Fq -- "--exclude='./BIG/wallpapers/**'" "$PROJECT_ROOT/bkp-main.sh"
grep -Fq -- "--exclude='./BIG/Firmware'" "$PROJECT_ROOT/bkp-main.sh"
grep -Fq -- "--exclude='./BIG/Firmware/**'" "$PROJECT_ROOT/bkp-main.sh"
grep -Fq -- "--exclude=\"\$RUN_ID/Documents/Firmware\"" "$PROJECT_ROOT/bkp-main.sh"
grep -Fq 'restore_shared_firmware' "$PROJECT_ROOT/restore-main.sh"
grep -Fq 'BIG/Firmware' "$PROJECT_ROOT/restore-main.sh"
